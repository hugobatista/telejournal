...
@dataclass
class PendingGitHubWrite:
    """Queued GitHub content write that will be flushed in batch."""

    payload: bytes
    message: str


class OneDriveAuthorizationRequiredError(RuntimeError):
...
class GitHubRepository:
    ...
    def __init__(
        ...
        self._pending_puts: dict[str, PendingGitHubWrite] = {}
    ...
    async def _queue_put_content(
        ...
        async with self._queue_lock:
            ...
            self._pending_puts[repo_path] = PendingGitHubWrite(
    ...
    def _flush_put_content(self, repo_path: str, pending: PendingGitHubWrite) -> None:
    ...
    async def flush_pending(self, reason: str = "manual") -> None:
        ...
        async with self._flush_lock:
            ...
            failed_puts: dict[str, PendingGitHubWrite] = {}
...
def build_repository(
    settings: Settings,
) -> VaultRepository | GitHubRepository | OneDriveRepository:
